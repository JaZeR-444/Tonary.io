...
- **Status (2026-07-02):** Foundation phase. The `Tonary.io/` folder contains this framework only — no Flutter code yet. Do not scaffold a full app without explicit confirmation (see §9 and `.claude/project/mvp-scope.md`).
